  ...
  render(): ReactNode {
    ...
    return (
      <main className="console-boundary" role="alert">
        ...
        <h1>当前工作区无法显示</h1>
        <code>ERROR_BOUNDARY_CAPTURED</code>
        <dl>
          <div><dt>影响</dt><dd>当前页面已停止渲染，未自动重放任何命令。</dd></div>
          <div><dt>下一步</dt><dd>重新载入当前页面；若仍失败，从任务中心按运行证据排查。</dd></div>
        </dl>
        <div>
          ...
          <a className="wb-button" href="/console/"><House size={15} aria-hidden="true" />返回任务首页</a>
        </div>
      </main>
    );
  }
