...
const plan = {
  ...
  workflow_stages: [{ stage_name: "asset_selection", stage_order: 4, status: "succeeded", attempt: 1 }, { stage_name: "quality_check", stage_order: 8, status: "pending", attempt: 1 }], quality_report: { passed: true, checks: { video_stream: true, subtitle_text_complete: true }, media: { duration_seconds: 55, width: 1080, height: 1920, video_codec: "h264", audio_codec: "aac", audio_sample_rate: 48000, frame_rate: 30, video_stream_duration_seconds: 55, audio_stream_duration_seconds: 55.04, audio_video_delta_seconds: .04 }, loudness: { integrated_lufs: -16.2, true_peak_db: -1.4, lra: 4.1 }, black_segments: [{ start_seconds: 2, end_seconds: 2.4, duration_seconds: .4 }], silence_segments: [], freeze_segments: [], subtitle_layout: { passed: true, checks: { subtitle_safe_area: true, subtitle_readable_duration: true }, safe_margins: { left: 72, right: 72, bottom: 160, headline_top: 220 }, required_script_block_codes: ["BLOCK-001", "BLOCK-002"], covered_script_block_codes: ["BLOCK-001", "BLOCK-002"], missing_script_block_codes: [], issues: [] } }, artifacts: [{ artifact_key: "video", download_url: "/files/final.mp4", mime_type: "video/mp4" }, { artifact_key: "poster", download_url: "/files/poster.jpg", mime_type: "image/jpeg" }, { artifact_key: "contact_sheet", download_url: "/files/contact-sheet.jpg", mime_type: "image/jpeg" }], timeline_segments: [{ segment_code: "VTLSEG-VIDPLAN-001-r1-SHOT-01", clip_code: "SHOT-01", source_shot_code: "CONTENT-SHOT-01", source_script_block_codes: ["BLOCK-001"], source_asset_file_refs: [{ asset_file_id: "file-001", asset_code: "ASSET-01", file_role: "original", object_key: "assets/ASSET-01/source.mp4", checksum_sha256: "a".repeat(64) }], execution_artifact_refs: [{ job_attempt: 1, artifact_role: "source_media_probe", artifact_key: "asset_plan", relative_path: "VIDJOB-001/attempt-1/assets/plan.json", checksum_sha256: "9".repeat(64), evidence: { stream_start_pts: "3600", stream_time_base: "1/90000", source_start_seconds: 0, source_end_seconds: 6, playback_rate: 1 } }, { artifact_role: "voice_segment", artifact_key: "voice", relative_path: "VIDJOB-001/attempt-1/voice/manifest.json", checksum_sha256: "e".repeat(64) }, { artifact_role: "subtitle_track", artifact_key: "subtitles", relative_path: "VIDJOB-001/attempt-1/subtitles/subtitles.ass", checksum_sha256: "f".repeat(64) }, { artifact_role: "render_manifest", artifact_key: "render_manifest", relative_path: "VIDJOB-001/attempt-1/render/manifest.json", checksum_sha256: "b".repeat(64) }, { artifact_role: "rendered_video", artifact_key: "video", relative_path: "VIDJOB-001/attempt-1/render/final.mp4", checksum_sha256: "c".repeat(64) }, { artifact_role: "poster", artifact_key: "poster", relative_path: "VIDJOB-001/attempt-1/render/poster.jpg", checksum_sha256: "d".repeat(64) }], timeline_start_ms: 0, timeline_end_ms: 30000, transition: "cut", fingerprint_sha256: "c".repeat(64) }, { segment_code: "VTLSEG-VIDPLAN-001-r1-SHOT-02", clip_code: "SHOT-02", source_shot_code: "CONTENT-SHOT-02", source_script_block_codes: ["BLOCK-002"], timeline_start_ms: 30000, timeline_end_ms: 60000, transition: "cut", fingerprint_sha256: "d".repeat(64) }], created_at: "2026-07-25T00:00:00Z", updated_at: "2026-07-25T00:00:00Z",
};
const musicOnlyPlan = {
  ...plan,
  render_profile: {
...
describe("VideoProductionPage", () => {
  ...
  it("saves the operator-selected clip order as a timeline revision", async () => {
    ...
    expect(screen.getByRole("button", { name: "跳转至 SHOT-01" })).toBeInTheDocument();
    expect(screen.getByRole("button", { name: "跳转至 SHOT-02" })).toBeInTheDocument();
    expect(screen.getByRole("slider", { name: "预览时间轴" })).toHaveValue("0");
