...
export const DEMO_REQUIREMENTS: ProductionRequirement[] = [
  {
    ...
    candidates: [
      { asset_code: "AG-VID-20260709-000018", title: "朋友聚餐举杯实拍", category: "视频", match_score: 0.91, analysis_source: "material.semantic-observation.v2" },
    ],
...
export const DEMO_PLAN_REVISIONS: PlanRevision[] = [
  {
    ...
    generation: { strategy_revision: "maitu.creative-plan.v2", prompt_version: "maitu-scene-plan.v1", invocation_evidence_ref: "ART-DEMO-001" },
...
export const DEMO_VIDEO_ANALYSES: VideoAnalysisItem[] = [
  {
    ...
    invocation_evidence_ref: "ART-DEMO-002",
  ...
  },
  {
    ...
    analysis_strategy_revision: "test.material-keyframe.v1",
